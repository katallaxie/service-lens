...
import type { getEnvironments } from "@/db/queries/environments"
import { useDataTable } from "@/hooks/use-data-table"
import type { QueryKeys } from "@/types/data-table"

import { AssignEnvironmentModal } from "./assign-environment-modal"
...
export function EnvironmentDataTable({ workloadId, promises, queryKeys }: EnvironmentTableProps) {
    ...
    <Tabs defaultValue="all" className="w-full flex-col justify-start gap-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <AssignEnvironmentModal workloadId={workloadId} />
        </div>
      </div>
